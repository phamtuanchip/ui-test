 ...
 * @date: 26/09/2012
 */
public class GateIn_GroupNavigation_OtheNodeActions_EditPage_Portlet extends GateInBase {
	/**
	 * @param args
	 */
	...
	//This case is pending because of issue GTNPORTAL-2807 -https://issues.jboss.org/browse/GTNPORTAL-2807
	//Add New Page By Wizard
	@Test(groups={"pending"})
	public void test23_CheckFinishFunctionOnEditingPageAfterEditedPagePortletLayout () {
		...
		waitForTextPresent("Application Registry Portlet");
		waitForTextPresent("Dashboard Portlet");
		//Delete node
		goToGroupSites();
		click(ELEMENT_EDIT_NAV_GROUP);
