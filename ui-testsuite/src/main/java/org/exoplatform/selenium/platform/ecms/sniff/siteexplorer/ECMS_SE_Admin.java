...
public class ECMS_SE_Admin extends PlatformBase {
	...
	public void test01_ExportNode() {
		...
		actBar.addItem2ActionBar("exportNode", actBar.ELEMENT_EXPORT_LINK, "Web");
	 ...
	 * Step 1: Add Category
	 * Note: To run cloud: need to add category in content administration (intranet/Defense/Healing)
	 */
	@Test
	...
	public void test04_ShowHideRelation() {
		...
		actBar.goToAddNewContent();
		cTemplate.createNewAnnouncement(node2, node2);
	...
	public void test07_ImportNode() {
		...
		actBar.goToViewMode("Web");
		actBar.addItem2ActionBar("importNode", actBar.ELEMENT_IMPORT_LINK, "Web");
		actBar.goToViewMode("Web");
		actBar.addItem2ActionBar("exportNode", actBar.ELEMENT_EXPORT_LINK, "Web");
		actBar.goToViewMode("Web");
