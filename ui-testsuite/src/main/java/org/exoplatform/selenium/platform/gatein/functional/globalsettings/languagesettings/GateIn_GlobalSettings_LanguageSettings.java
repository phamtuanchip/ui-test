package org.exoplatform.selenium.platform.gatein.functional.globalsettings.languagesettings;
 ...
 *@date: 26/09/2012
 */
public class GateIn_GlobalSettings_LanguageSettings extends ManageAccount{
	...
	public void test07_CheckDisplayLanguageOfPortalWithNewAccountIsCreatedInPublicMode(){
		...
		driverOriginal.get(baseUrl);
		signIn("root", "gtn");
		goToRegisterPageInPublicMode(driverOriginal);
		goToEditPageEditor();
