	 ...
	 @BeforeMethod
	  ...
	  @Test
		public void CheckPrintingPDF() {
	  	...
	  	By ELEMENT_INPUT_SEARCH = By.xpath("//input[@name='keyword']");
	    ...
	    // goto Site Explorer
		  ...
		  // Upload PDF file
			...
			pause(1000);
			// Open uploaded file
			info("Open the uploaded PDF file");
			doubleClickOnElement(ELEMENT_UPLOADED);			
			//Published document
			info("Publish uploaded PDF file");
			...
			//Click Enter
			info("Click enter");
			WebElement element = driver.findElement(ELEMENT_INPUT_SEARCH);
		  element.sendKeys(Keys.ENTER);
			//Expected: The uploaded file displays
		  captureScreen("REG_PLF309_ECMS_008");
